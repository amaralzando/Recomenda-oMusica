...
public class Avaliacaoview extends javax.swing.JFrame {
     ...
     */
    public Avaliacaoview() throws SQLException, IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton2.setText("Confirmar Avaliacoes");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(Avaliacaoview.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void setAvaliacaoTable(Object[] data) {
        DefaultTableModel dtmAva = (DefaultTableModel) tableNotas.getModel();
        dtmAva.addRow(data);
    }

    public void saveAvaliacao() throws IOException, SQLException {
        ...
        for (int i = 0; model.getRowCount() > i; i++) {
            ...
            controller.salvarAvaliacao(col1, col2);
            controller.mediaAvalaicao(col1);
        }
    }
